## This repo contains code for our novel Localization module than uses a subset of lidar data filter using image semantics, and the implementation of SOIC auto-calibration paper
